...
probabilistic_final_policy_weights, probabilistic_statistics_history, experiment_time = run_experiment("Probabilistic (no heuristic) - DRP", run_planner, environment=probabilistic_environment, planner_parameters=probabilistic_planner_parameters)
...
save_time("Probabilistic (no heuristic) - DRP", experiment_time, f'{root_folder}/zzz_deepreactive_time.csv')