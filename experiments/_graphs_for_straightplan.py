...
def plot_learning_curve(title, no_heuristic_stats, heuristic_stats):
    ...
    plt.savefig(f'{root_folder}/zzz_graph_learningcurve_straightline.png', format='png')
...
def plot_time_bars(title, time_data):
    ...
    plt.savefig(f'{root_folder}/zzz_graph_time_straightline.png', format='png')
...
no_heuristic_stats = load_data(f'{root_folder}/zzz_probabilistic_no_heuristic_straightline_statistics.pickle')
heuristic_stats = load_data(f'{root_folder}/zzz_probabilistic_with_heuristic_straightline_statistics.pickle')

plot_learning_curve("Learning Curve - Straight line Plan", no_heuristic_stats, heuristic_stats)
