...
save_data(deterministic_final_policy_weights, '/Users/danielbdias/Development/Repositories/studies/doctorate/experiments/planning-through-backpropagation/experiment_data/deterministic_straightline_policy.pickle')
save_data(deterministic_statistics_history, '/Users/danielbdias/Development/Repositories/studies/doctorate/experiments/planning-through-backpropagation/experiment_data/deterministic_straightline_statistics.pickle')

# Step 2 - run planner with probabilistic environment and weights from last step
probabilistic_domain_file='/Users/danielbdias/Development/Repositories/studies/doctorate/experiments/planning-through-backpropagation/domains/probabilistic_navigation/domain.rddl'
...
probabilistic_planner_parameters = PlannerParameters(
    batch_size_train=32,
    plan=JaxStraightLinePlan(initializer=initializers.constant(deterministic_final_policy_weights['move'])),
    optimizer=optax.rmsprop,
    learning_rate=0.1,
    epochs=1000,
    seed=jax.random.PRNGKey(42),
...
save_data(probabilistic_final_policy_weights, '/Users/danielbdias/Development/Repositories/studies/doctorate/experiments/planning-through-backpropagation/experiment_data/probabilistic_with_heuristic_straightline_policy.pickle')
save_data(probabilistic_statistics_history, '/Users/danielbdias/Development/Repositories/studies/doctorate/experiments/planning-through-backpropagation/experiment_data/probabilistic_with_heuristic_straightline_statistics.pickle')