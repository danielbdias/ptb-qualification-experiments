...
save_data(deterministic_final_policy_weights, f'{root_folder}/deterministic_straightline_policy.pickle')
save_data(deterministic_statistics_history, f'{root_folder}/deterministic_straightline_statistics.pickle')
...
probabilistic_planner_parameters = PlannerParameters(
    batch_size_train=32,
    plan=JaxStraightLinePlan(initializer=initializers.constant(deterministic_final_policy_weights['release'])),
    optimizer=optax.rmsprop,
    learning_rate=0.1,
    epochs=1000,
    seed=jax.random.PRNGKey(42),
...
save_data(probabilistic_final_policy_weights, f'{root_folder}/probabilistic_with_heuristic_straightline_policy.pickle')
save_data(probabilistic_statistics_history, f'{root_folder}/probabilistic_with_heuristic_straightline_statistics.pickle')