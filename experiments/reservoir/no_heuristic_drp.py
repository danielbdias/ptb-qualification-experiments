...
save_data(probabilistic_final_policy_weights, f'{root_folder}/probabilistic_no_heuristic_deepreactive_policy.pickle')
save_data(probabilistic_statistics_history, f'{root_folder}/probabilistic_no_heuristic_deepreactive_statistics.pickle')