...
for domain in domains:
    ...
    for jax_seed in jax_seeds:
        ...
        heuristic_env_experiment_summary = run_experiment(f"{domain.name} (abstraction) - Straight line", environment=heuristic_environment, planner_parameters=heuristic_env_params, silent=silent)
