...
save_data(deterministic_final_policy_weights, f'{root_folder}/deterministic_deepreactive_policy.pickle')
save_data(deterministic_statistics_history, f'{root_folder}/deterministic_deepreactive_statistics.pickle')
...
save_data(probabilistic_final_policy_weights, f'{root_folder}/probabilistic_with_heuristic_deepreactive_policy.pickle')
save_data(probabilistic_statistics_history, f'{root_folder}/probabilistic_with_heuristic_deepreactive_statistics.pickle')