...
no_heuristic_stats_file = f'{root_folder}/probabilistic_no_heuristic_straightline_statistics.pickle'
heuristic_stats_file = f'{root_folder}/probabilistic_with_heuristic_straightline_statistics.pickle'
